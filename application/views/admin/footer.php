...
<!-- End of Main Content -->
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Laurent Pause - Teste Simplon</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <script src="<?=base_url();?>asset/template/admin/vendor/jquery/jquery.min.js"></script>
  <script src="<?=base_url();?>asset/template/admin/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

  <!-- Core plugin JavaScript-->
  <script src="<?=base_url();?>asset/template/admin/vendor/jquery-easing/jquery.easing.min.js"></script>
